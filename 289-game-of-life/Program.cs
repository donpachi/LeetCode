...
namespace _289_game_of_life
{
    class Program
    {
        ...
        //resulting in 9n queries. Therefore, time complexity is O(n) where n is total count of the 2d array. In terms of dimensions, time is O(n^2) or O(nm) if the dimensions differ.
